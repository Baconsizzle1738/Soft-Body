...
//		MassPoint m4 = new MassPoint(200, 200);
		...
		Spring s2 = new Spring(BigDecimal.valueOf(100), BigDecimal.valueOf(0.05), m2, m3);
//		Spring s3 = new Spring(100f, 0.05f, m3, m4);
//		Spring s4 = new Spring(100f, 0.05f, m4, m1);
		Spring s5 = new Spring(BigDecimal.valueOf(141.4214f), BigDecimal.valueOf(0.05), m1, m3);
//		Spring s6 = new Spring(141.4214f, 0.05f, m2, m4);
